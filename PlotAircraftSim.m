...
%% Figures 1 - 4
    ...
    figure(fig(5));
    hold on;
    subplot(411); plot(time, control_input_array(1,:), col); hold on; ylabel('Z_c [N]');
    subplot(412); plot(time, control_input_array(2,:), col); hold on; ylabel('L_c [Nm]');
    subplot(413); plot(time, control_input_array(3,:), col); hold on; ylabel('M_c [Nm]');
    subplot(414); plot(time, control_input_array(4,:), col); hold on; ylabel('N_c [Nm]');
    xlabel('Time [s]');
